...
train_first_match_ind = np.argmax((np.expand_dims(train_seq_ind[:,0],1) == train_seq_ind[:,3:]).astype(float),1) + 2
train_second_match_ind = np.argmax((np.expand_dims(train_seq_ind[:,1],1) == train_seq_ind[:,3:]).astype(float),1) + 2
train_third_match_ind = np.argmax((np.expand_dims(train_seq_ind[:,2],1) == train_seq_ind[:,3:]).astype(float),1) + 2
...
test_first_match_ind = np.argmax((np.expand_dims(test_seq_ind[:,0],1) == test_seq_ind[:,3:]).astype(float),1) + 2
test_second_match_ind = np.argmax((np.expand_dims(test_seq_ind[:,1],1) == test_seq_ind[:,3:]).astype(float),1) + 2
test_third_match_ind = np.argmax((np.expand_dims(test_seq_ind[:,2],1) == test_seq_ind[:,3:]).astype(float),1) + 2
